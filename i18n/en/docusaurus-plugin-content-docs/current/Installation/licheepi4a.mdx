...
If your MicroSD card is not on the list of known compatible cards and you encounter issues such as failure to write the image or failure to boot after writing, refer to [this page](../issue) to submit an issue. You can also try the [eMMC boot guide](#emmc) for writing the image.  
